...
/**
 * GET /api/social/youtube/analytics/devices
 * Playback device type distribution with view percentage shares.
 */
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await youtubeDashboardService.getDevices({
      workspaceId,
      socialAccountId,
      startDate,
      endDate,
