...
/**
 * GET /api/social/youtube/analytics/audience
 * Audience demographics (age group & gender distribution; period aggregate only).
 */
export async function GET(req: NextRequest) {
  try {
    ...
    const result = await youtubeDashboardService.getAudience({
      workspaceId,
      socialAccountId,
      startDate,
      endDate,
